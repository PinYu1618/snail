...
use crate::feature;
use crate::mem;
use crate::mem::SupervisorPointer;
use crate::hsm;
use crate::hsm::Hsm;
use crate::hsm::HsmCommand;
use crate::runtime::{MachineTrap, Runtime, SupervisorContext};

pub fn execute_supervisor(supervisor_mepc: usize, hart_id: usize, a1: usize, hsm: Hsm) -> ! {
    ...
    loop {
        match Pin::new(&mut rt).resume(()) {
            ...
            GeneratorState::Yielded(MachineTrap::IllegalInstruction()) => {
                ...
                let deref_ans = unsafe { mem::try_read(ptr) };
            ...
            GeneratorState::Complete(()) => {
                use rustsbi::Reset;
                crate::sifive::SiFive.system_reset(
