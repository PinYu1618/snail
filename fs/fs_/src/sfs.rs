use spin::Mutex;
use crate::{
    Bitmap, BlockCacher, BlockDevice, DataBlock, DiskInode,
...
impl SnailFileSystem {
    ...
    pub fn create(
        ...
        for i in 0..total_blocks {
            BlockCacher::cache_block(i as usize, Arc::clone(&block_dev))
                .lock()
        ...
        BlockCacher::cache_block(0, Arc::clone(&block_dev))
            .lock()
        ...
        BlockCacher::cache_block(root_inode_block_id as usize, Arc::clone(&block_dev))
            .lock()
    ...
    pub fn dealloc_data(&mut self, block_id: u32) {
        BlockCacher::cache_block(block_id as usize, Arc::clone(&self.block_dev))
            .lock()
            .modify(0, |data_block: &mut DataBlock| {
